...
class RayPPOTrainer:
    ...
    def _dump_generations(self, inputs, outputs, groud_truths, scores, reward_extra_infos_dict, dump_path):
        ...
        for i in range(n):
            ...
            lines.append(json.dumps(entry, ensure_ascii=False, indent=4))
    ...
    def _validate(self):
        ...
        for test_data in self.val_dataloader:
            ...
            for i in range(len(test_batch)):
                groud_truths.append(test_batch[i].non_tensor_batch["reward_model"]["ground_truth"])
            ...
            input_texts = [self.tokenizer.decode(ids).replace("<|fim_pad|>", "") for ids in input_ids]
            ...
            output_texts = [self.tokenizer.decode(ids).replace("<|fim_pad|>", "") for ids in output_ids]
